...
BOEFFLA_VERSION="3.0-beta1-OOS12-bacon"
...
MKBOOTIMG_CMDLINE="androidboot.hardware=qcom user_debug=30 msm_rtb.filter=0x3b7 ehci-hcd.park=3 androidboot.bootdevice=msm_sdcc.1"
MKBOOTIMG_BASE="0x00000000"
MKBOOTIMG_PAGESIZE="2048"
MKBOOTIMG_RAMDISK_OFFSET="02000000"
